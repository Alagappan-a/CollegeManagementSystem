...
public class ArtsApplicationForm extends ApplicationForm implements ApplicationFormMethods {
	ArrayList<String> artsDeptList = new ArrayList<>();
	void addCourses() {
		artsDeptList.add("1.Department of Mathematics and Statistics");
		artsDeptList.add("2.Department of Biotechnology");
		artsDeptList.add("3.Department of Computer Science");
		artsDeptList.add("4.Department of Commerce");
		artsDeptList.add("5.Department of Corporate Secretaryship and Accounting & Finance");
		artsDeptList.add("6.Department of English");
		artsDeptList.add("7.Department of Tamil");
	}
	...
	void registerInDB(String firstName,String lastName,String parentName,String gender,String mobileNumber,String emailID,int age,int dept,String schoolName,int mark,int cutOffMark){
		...
		try {
			...
			String query = "insert into Arts_Student_Details(Student_First_Name,Student_Last_Name,Parent_Name,Student_Gender,Contact_Number,Mail_ID,Student_age,Department_ID ,School_Name,12th_Mark,cut_Off_Mark) values(?,?,?,?,?,?,?,?,?,?,?)";
	...
	public int getDepartment() {
		...
		System.out.println("Courses available in Arts & science are:");
		for (String dept:artsDeptList
		) {
	...
	public void getArtsstudentDetails() {
		System.out.println("----------------------------------------------------------------------");
		System.out.println("\t\t\t\tArts & Science Application Form");
		System.out.println("----------------------------------------------------------------------");
		addCourses();
		...
		if(dept==1&&cutOffMark<160){
			...
			System.out.println("congratulations..!\n you are selected for "+artsDeptList.get(dept-1) );
